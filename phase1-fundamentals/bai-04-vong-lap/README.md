...
Hãy chạy thử và thay đổi dữ liệu. Thầy muốn bạn **thử nghiệm** chứ không chỉ copy xem.
...
Bài vừa rồi bạn đã dùng mảng (`ten[]`, `soLuong[]`, `gia[]`) nhưng chưa thực sự học về mảng. Bài tiếp theo thầy sẽ đi sâu vào mảng và String — hai thứ bạn sẽ dùng hàng ngày.
